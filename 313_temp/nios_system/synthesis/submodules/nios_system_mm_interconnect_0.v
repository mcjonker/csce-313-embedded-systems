...
module nios_system_mm_interconnect_0 (
	...
	wire  [94:0] system_modes_s1_agent_rf_source_data;                                               // system_modes_s1_agent:rf_source_data -> system_modes_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] system_modes_s1_agent_rsp_fifo_out_data;                                            // system_modes_s1_agent_rsp_fifo:out_data -> system_modes_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> system_modes_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // system_modes_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> system_modes_s1_agent:cp_channel
	...
	wire  [94:0] system_counter_s1_agent_rf_source_data;                                             // system_counter_s1_agent:rf_source_data -> system_counter_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] system_counter_s1_agent_rsp_fifo_out_data;                                          // system_counter_s1_agent_rsp_fifo:out_data -> system_counter_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> system_counter_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // system_counter_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> system_counter_s1_agent:cp_channel
	...
	wire  [94:0] random_pattern_s1_agent_rf_source_data;                                             // random_pattern_s1_agent:rf_source_data -> random_pattern_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] random_pattern_s1_agent_rsp_fifo_out_data;                                          // random_pattern_s1_agent_rsp_fifo:out_data -> random_pattern_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> random_pattern_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // random_pattern_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> random_pattern_s1_agent:cp_channel
	...
	wire  [93:0] system_modes_s1_agent_rp_data;                                                      // system_modes_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] system_counter_s1_agent_rp_data;                                                    // system_counter_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [93:0] random_pattern_s1_agent_rp_data;                                                    // random_pattern_s1_agent:rp_data -> router_007:sink_data
