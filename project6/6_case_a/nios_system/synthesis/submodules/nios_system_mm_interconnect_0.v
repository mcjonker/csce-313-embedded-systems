...
module nios_system_mm_interconnect_0 (
	...
	wire          cmd_mux_007_src_valid;                                                                          // cmd_mux_007:src_valid -> processor_debug_mem_slave_agent:cp_valid
	wire  [109:0] cmd_mux_007_src_data;                                                                           // cmd_mux_007:src_data -> processor_debug_mem_slave_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                                          // processor_debug_mem_slave_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                                                        // cmd_mux_007:src_channel -> processor_debug_mem_slave_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                                  // cmd_mux_007:src_startofpacket -> processor_debug_mem_slave_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                                    // cmd_mux_007:src_endofpacket -> processor_debug_mem_slave_agent:cp_endofpacket
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                                        // cmd_mux_008:src_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire  [109:0] cmd_mux_009_src_data;                                                                           // cmd_mux_009:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [109:0] sysid_qsys_0_control_slave_agent_rp_data;                                                       // sysid_qsys_0_control_slave_agent:rp_data -> router_009:sink_data
	...
	wire          processor_debug_mem_slave_agent_rp_valid;                                                       // processor_debug_mem_slave_agent:rp_valid -> router_010:sink_valid
	wire  [109:0] processor_debug_mem_slave_agent_rp_data;                                                        // processor_debug_mem_slave_agent:rp_data -> router_010:sink_data
	wire          processor_debug_mem_slave_agent_rp_ready;                                                       // router_010:sink_ready -> processor_debug_mem_slave_agent:rp_ready
	wire          processor_debug_mem_slave_agent_rp_startofpacket;                                               // processor_debug_mem_slave_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          processor_debug_mem_slave_agent_rp_endofpacket;                                                 // processor_debug_mem_slave_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire    [9:0] cmd_demux_002_src0_channel;                                                                     // cmd_demux_002:src0_channel -> cmd_mux_007:sink1_channel
	...
	wire    [9:0] rsp_demux_007_src1_channel;                                                                     // rsp_demux_007:src1_channel -> rsp_mux_002:sink0_channel
	...
	wire    [9:0] cmd_demux_001_src8_channel;                                                                     // cmd_demux_001:src8_channel -> crosser:in_channel
	...
	wire    [9:0] crosser_002_out_channel;                                                                        // crosser_002:out_channel -> rsp_mux_001:sink8_channel
	...
	wire          processor_debug_mem_slave_agent_rdata_fifo_src_valid;                                           // processor_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] processor_debug_mem_slave_agent_rdata_fifo_src_data;                                            // processor_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          processor_debug_mem_slave_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_007:in_0_ready -> processor_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                              // avalon_st_adapter_007:out_0_valid -> processor_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                               // avalon_st_adapter_007:out_0_data -> processor_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                              // processor_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                              // avalon_st_adapter_007:out_0_error -> processor_debug_mem_slave_agent:rdata_fifo_sink_error
	...
	nios_system_mm_interconnect_0_cmd_demux rsp_demux_009 (
		.clk                (sys_sdram_pll_sys_clk_clk),              //       clk.clk
		.reset              (jtag_reset_reset_bridge_in_reset_reset), // clk_reset.reset
